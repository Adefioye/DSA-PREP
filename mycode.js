async function createService(req, res, next) {
  try {
    // For array of objects, we iterate through request body payload and
    // push each response from each object in the req body into a bulk response array
    // The bulk response is then attached to the data property of the returned JSON payload
    bulkResponse = [];

    // Loop over an array of request body
    req.body.forEach(async (data) => {
      ...
      // Response is pushed into bulk response after updating location of the vehicle
